...
EquidistantCamera::Parameters::Parameters()
    : Camera::Parameters(KANNALA_BRANDT), m_k2(0.0), m_k3(0.0), m_k4(0.0),
      m_k5(0.0), m_mu(0.0), m_mv(0.0), m_u0(0.0), m_v0(0.0) {}
...
EquidistantCamera::Parameters::Parameters(const std::string &cameraName, int w,
    ...
    : Camera::Parameters(KANNALA_BRANDT, cameraName, w, h), m_k2(k2), m_k3(k3),
