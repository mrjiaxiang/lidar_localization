...
void readParameters(std::string config_file) {
    ...
    LOG(INFO) << "camera number: " << NUM_OF_CAM;
    if (NUM_OF_CAM != 1 && NUM_OF_CAM != 2) {
        LOG(INFO) << "num_of_cam should be 1 or 2\n";
        assert(0);
    }
    ...
    FRAME_GRID_ROWS = fsSettings["frame_grid_rows"];
    FRAME_GRID_COLS = fsSettings["frame_grid_cols"];
